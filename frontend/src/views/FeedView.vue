            ...
            <div class="main-center col-span-4 space-y-4">
                ...
                <div class="bg-[#f6f6f2] border border-gray-200 rounded-lg">
                    <form action="" method="post" v-on:submit.prevent="submitForm" >
                        <div class="p-4">  
                        <textarea v-model="body" class="p-4 w-full bg-white rounded-lg" placeholder="What are you thinking about?"></textarea>
                        </div>
                ...
                <div class="p-4 bg-[#f6f6f2] border border-gray-200 rounded-lg" v-for="post in posts" v-bind:key="post.id">
